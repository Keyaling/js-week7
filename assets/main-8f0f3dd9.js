...
`})):e.value!==""&&(c.push(r),c.forEach(function(a){d[a].innerHTML=i}))}),t.length===0){let e={};e.id=o.length,e.name=g.value,e.imgUrl=h.value,e.area=v.value,e.price=y.value,e.group=b.value,e.rate=k.value,e.description=C.value,o.push(e),s(o),f(o),document.querySelector(".addTicket-form").reset()}});console.log("Hello world!");
